...
MIN_FEATURES = 400
OUTPUT_FILE  = "velocities_v12.txt"
...
with open(OUTPUT_FILE, "w") as log:
    log.write("timestamp,speed_sp_ma,speed_sp_lp,speed_sift_ma,speed_sift_lp,speed_gt\n")
    ...
    while True:
        ...
        log.write(f"{curr_time:.6f},{speed_sp_ma:.6f},{speed_sp_lp:.6f},"
                  f"{speed_sift_ma:.6f},{speed_sift_lp:.6f},{speed_gt:.6f}\n")
        log.flush()

        print(f"dt={dt*1000:.1f}ms | SP-MA={speed_sp_ma:.3f}  SP-LP={speed_sp_lp:.3f}"
              f" | SIFT-MA={speed_sift_ma:.3f}  SIFT-LP={speed_sift_lp:.3f} | GT={speed_gt:.3f}")
