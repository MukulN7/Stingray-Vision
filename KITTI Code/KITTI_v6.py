...
for frame_idx in tqdm(range(START_FRAME + 1, END_FRAME), desc="Processing frames"):
    ...
    vx_sp_history.append(vx_sp)
    vy_sp_history.append(vy_sp)

    vx_sift_history.append(vx_sift)
    vy_sift_history.append(vy_sift)
